# myLocalGPT: Secure, Local Conversations with Your Documents 🌐

17-Mar-2024

<code> I integrate server functionality </code>
venv: mygpt (localGPT)
back-server file: run_localGPT_API.py
UI in folder localGPTUI/ui_server.py

this is the working version

### Install new venv with requirements.txt



### Not used conda due to packages incompatibility - using venv .gpt
source .gpt/bin/activate


#### models - folder at same level as local GPT folder and path to external drive

#### Conda not used for incompatibility packages
conda install --file requirements.txt

**Dependencies**
Sentence-transformers==2.2.2
llama-cpp to be installed

# LocalGPT: Convert Your Chats with Docs to Fine-tuning Datasets

# https://www.youtube.com/watch?v=2_o6epQToVY
